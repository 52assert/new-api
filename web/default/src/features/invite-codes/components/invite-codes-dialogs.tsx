...
*/
import { InviteCodesGeneratedDialog } from './invite-codes-generated-dialog'
import { InviteCodesMutateDrawer } from './invite-codes-mutate-drawer'
import { useInviteCodes } from './invite-codes-provider'
import { InviteCodesUsagesDialog } from './invite-codes-usages-dialog'
...
export function InviteCodesDialogs() {
  ...
  return (
    <>
      ...
      />
      <InviteCodesGeneratedDialog />
      <InviteCodesUsagesDialog />
    </>
  )
}
